...
ActiveRecord::Schema.define(version: 20180615225803) do
  ...
  create_table "document_owners", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.bigint "document_id"
    t.string "owner_name"
    t.string "owner_email"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id"], name: "index_document_owners_on_document_id"
  end
